...
3D (ZORUNLU):   React Three Fiber + Drei (Statik tasarım yasaktır, her sayfada canlı 3D objeler olmalıdır)
...
## 🚨 Ajan Yönergeleri: 3D Animasyon Mimarisi
- Tüm ana sayfa (Hero) ve etkileşim gerektiren geçişlerde WebGL / Three.js KESİNLİKLE kullanılacaktır.
- Salt HTML box-shadow veya gradient tabanlı minimal tasarımlar, 3D elementlerle zenginleştirilmek zorundadır.
- "Sade / Basit" tasarımlardan uzak durulacak; animasyonlar (Framer Motion) ve uzaysal derinlik (R3F) entegre edilecektir.
